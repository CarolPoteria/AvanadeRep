...
namespace APIDesafio.Controllers
{
    public class FilmeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Nome,DataLancamento,Diretor,IDGenero")] Filme filme)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Nome,DataLancamento,Diretor,IDGenero")] Filme filme)
        {
            if (id != filme.ID)
            {
                return NotFound();
